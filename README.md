...
its a simple powershell script i snatched  from nishanga a usefully for reverse shell most for windows, so as i can't get hard time most to get a reverse shell on windows
